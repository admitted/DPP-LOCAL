...
public class TcpSvr extends Thread {
    ...
    public TcpSvr(DBUtil dbUtil) throws Exception {
        ...
        m_iPort    = Integer.parseInt(root.element("app_server").element("server_prot").getText());    // 61020
        m_iTimeOut = Integer.parseInt(root.element("app_server").element("server_timeout").getText()); // 60
