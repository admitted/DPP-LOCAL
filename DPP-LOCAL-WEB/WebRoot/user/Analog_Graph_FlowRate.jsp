...
<%
  ...
  CurrStatus currStatus = (CurrStatus)session.getAttribute("CurrStatus_" + Sid);
	String Analog_Graph_FlowRate = (String)session.getAttribute("Analog_Graph_FlowRate_" + Sid);
...
<body >
<form name='Analog_Graph_FlowRate'   method='post' target='mFrame'>
...
<SCRIPT LANGUAGE=javascript>
		...
		var data_serie = [];
		var data_xAxis = [];
		var Analog_Graph_FlowRate = "<%=Analog_Graph_FlowRate%>";
		var WaterLev;
		if(Analog_Graph_FlowRate != null && Analog_Graph_FlowRate.length > 0)
		{
			WaterLev = Analog_Graph_FlowRate.split("|");
