...
<%
  ...
  CurrStatus currStatus = (CurrStatus)session.getAttribute("CurrStatus_" + Sid);
	String Analog_Graph_ActualFlow = (String)session.getAttribute("Analog_Graph_ActualFlow_" + Sid);
...
<body >
<form name='Analog_Graph_ActualFlow'   method='post' target='mFrame'>
...
<SCRIPT LANGUAGE=javascript>
		...
		var data_serie = [];
		var data_xAxis = [];
		var Analog_Graph_ActualFlow = "<%=Analog_Graph_ActualFlow%>";
		var WaterLev;
		if(Analog_Graph_ActualFlow != null && Analog_Graph_ActualFlow.length > 0)
		{
			WaterLev = Analog_Graph_ActualFlow.split("|");
